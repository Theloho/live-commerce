...
class OrderRepository {
  ...
  async updatePayment(orderId, paymentData) {
    try {
      ...
      // 🔍 디버깅: Repository에서 받은 paymentData 확인
      console.log('🔍 [OrderRepository.updatePayment] 받은 데이터:', {
        orderId,
      ...
      // 🔍 디버깅: DB 저장 결과 확인
      console.log('🔍 [OrderRepository.updatePayment] DB 저장 결과:', {
        orderId,
        depositor_name: result.depositor_name
      })
