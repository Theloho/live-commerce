    ...
    try {
      ...
      return orders.map(order => {
        ...
        try {
          ...
          // ⭐ 대표 주문: created_at 기준으로 가장 오래된 주문 (첫 번째 주문)
          ...
          return {
            ...
            bulkPaymentInfo: {
              ...
              // ⭐ 일괄결제 총 입금금액 = 각 주문의 (total_amount - discount_amount) 합계
              groupTotalAmount: groupOrders.reduce((sum, o) => {
                const finalAmount = (o.total_amount || 0) - (o.discount_amount || 0)
